...
export const STARTER_RECIPES = [
  ...
  makeStarter("school-subject", "School Subject Unit", "School-age learners with teacher support", "scaffolded", { explanation: 3, worked_example: 2, recap: 1 }, { mix: ["multiple_choice", "true_false"] }, "Teacher review is required for age and curriculum fit"),
  makeStarter("exam-prep", "Exam Preparation", "Learners preparing for a defined assessment", "practice-led", { explanation: 2, worked_example: 2, flashcard: 2 }, { mix: ["multiple_choice", "true_false"] }, "Do not imply affiliation with an exam owner"),
