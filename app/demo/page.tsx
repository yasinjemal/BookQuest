...
export const metadata: Metadata = publicMetadata({
  ...
  description: "See how BookQuest turns a shop manual into an editable course with readable source material, learning checks, progress, and completion evidence.",
  path: "/demo",
});
