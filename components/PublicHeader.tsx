...
export default function PublicHeader() {
  return <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
    ...
    <nav className="flex items-center gap-2 text-sm font-semibold" aria-label="Public navigation">
      <Link href="/explore" className="hidden rounded-full px-4 py-2.5 text-ink-soft hover:bg-card sm:inline-flex">Explore</Link>
      <Link href="/pricing" className="hidden rounded-full px-4 py-2.5 text-ink-soft hover:bg-card sm:inline-flex">Pricing</Link>
