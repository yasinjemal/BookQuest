    ...
    <div className="min-h-dvh bg-pine px-3 py-3 text-white sm:px-6 sm:py-6">
      <div className="mx-auto grid min-h-[calc(100dvh-1.5rem)] max-w-6xl overflow-hidden rounded-[1.75rem] border border-white/10 bg-forest shadow-pop sm:min-h-[calc(100dvh-3rem)] lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12">
          <p className="course-accent-text text-[10px] font-bold uppercase tracking-[0.18em]">You have reached the next chapter</p>
          ...
          {certificateId && <Link href={`/cert/${certificateId}`} className="course-accent-text mt-6 inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-current/35 bg-white/5 px-5 py-3 text-sm font-semibold"><AppIcon name="shield" className="h-4 w-4" />View course credential</Link>}
